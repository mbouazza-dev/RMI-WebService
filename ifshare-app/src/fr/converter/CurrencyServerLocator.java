...
public class CurrencyServerLocator extends org.apache.axis.client.Service implements fr.converter.CurrencyServer {
 ...
 */
    ...
    private java.lang.String CurrencyServerSoap_address = "https://fx.currencysystem.com/webservices/CurrencyServer5.asmx";
    ...
    public fr.converter.CurrencyServerSoap getCurrencyServerSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.converter.CurrencyServerSoapStub _stub = new fr.converter.CurrencyServerSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.converter.CurrencyServerSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.converter.CurrencyServerSoapStub _stub = new fr.converter.CurrencyServerSoapStub(new java.net.URL(CurrencyServerSoap_address), this);
                _stub.setPortName(getCurrencyServerSoapWSDDServiceName());
                return _stub;
            }
        }
